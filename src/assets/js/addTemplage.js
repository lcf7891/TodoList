const viewGlobalAll = `
<!-- 起始頁面 -->
  <section class="container vh-100" id="js-user-control">
    <div class="row align-items-center h-100">
      ...
      <div class="col-lg-6">
        <div class="row justify-content-center">
          <!-- 登入 -->
          <div class="col-md-8" id="js-signIn-control">
          ...
          <!-- 註冊 -->
          <div class="col-md-8 d-none" id="js-signUp-control">
            <div class="mb-5 d-lg-none text-center">
              <a href="index.html"><img src="./assets/images/logo_lg.png" alt="logo_lg"></a>
            </div>
            <div class="mb-6">
  ...
  <!-- 登入後 -->
  <section class="container-fluid d-none" id="js-todos-control">
    ...
    <article class="row justify-content-center">
      <div class="col-md-6">
        ...
        <!-- 無待辦事項 -->
        <div class="text-center" id="js-noList-control">
          <p class="fs-3">目前尚無代辦事項</p>
          <img src="./assets/images/empty.png" class="img-fluid" alt="empty">
        </div>
        <!-- 有待辦事項 -->
        <ul class="d-flex text-center fs-5 d-none" id="js-list-control">
